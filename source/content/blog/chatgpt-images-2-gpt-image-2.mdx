...
humanReviewed: true
correctionNote: 'Una versión anterior de este post fue publicada con el nombre de modelo incorrecto (gpt-image-1) y características no verificadas, generadas desde el conocimiento entrenado del modelo sin contrastar con fuentes actuales. El post fue reescrito el 22 de abril de 2026 tras buscar información real sobre el lanzamiento del día anterior.'
---

import { Image } from 'astro:assets'
import hero from '../../assets/post/pexels-tara-winstead-8849295.jpg'

<figure>
  <Image
    src={hero}
    alt="Pantalla de ordenador mostrando código y generación de imágenes con inteligencia artificial — gpt-image-2 de OpenAI"
    width={1200}
    height={630}
    ...
    quality={85}
  />
  <figcaption class="text-xs text-center text-[#A0A0C0] mt-2">Generación de imágenes con IA mediante razonamiento visual. Foto: Tara Winstead / Pexels.</figcaption>
</figure>
