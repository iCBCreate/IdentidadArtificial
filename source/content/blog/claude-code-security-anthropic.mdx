...
reviewNotes: 'Artículo pendiente de revisión humana final; el pipeline conserva esta señal visible hasta que se valide manualmente.'
claimsReviewed:
  - 'La pieza diferencia revisión agente, SAST clásico y aprobación humana.'
  - 'Se evita presentar el agente como sustituto automático del equipo de seguridad.'
---
