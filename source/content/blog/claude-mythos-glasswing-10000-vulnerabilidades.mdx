...
description: 'Project Glasswing: Claude Mythos Preview encontró más de 10.000 vulnerabilidades críticas en software estratégico en solo un mes.'
pubDate: 2026-05-25
category: 'Modelos'
...
Anthropic no es la única compitiendo en esta capa: [la comparativa entre GPT-5.5 Cyber y Claude Mythos 5](/gpt-5-5-cyber-vs-mythos-fable-acceso-restringido/) analiza cómo OpenAI responde con su propio modelo de acceso restringido para ciberseguridad.
