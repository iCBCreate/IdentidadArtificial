...
Ese mismo principio —separar el razonamiento del conocimiento— explica también por qué [ChatGPT, Claude, Perplexity y Google AI Overviews no obtienen información de la web de la misma forma](/tutoriales/que-indexan-realmente-los-llms/): cada plataforma implementa su propia versión de recuperación externa, con fuentes y frecuencias de actualización distintas.
...
Puedes experimentar con esta idea en el [explorador de embeddings del laboratorio](/laboratorio/embeddings/): un modelo real corre en tu navegador, convierte frases en vectores y muestra su similitud semántica.
